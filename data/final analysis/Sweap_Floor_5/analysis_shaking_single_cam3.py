...
camera_data_path = "TS1_125s_2025-03-06_17-41-49.csv"
ldv_data_path = "protocol_optoNCDT-ILD1420_2025-03-06_17-41-50.407.csv"
val = 5
Nfft = 2**12
...
max_cam = camd_time_plot['Cam3 Position X'].max()
min_cam = camd_time_plot['Cam3 Position X'].min()
...
plt.plot(resampled_time_plot, camd_time_plot['Cam3 Position X'].values, label=f'Camera Data (Max: {max_cam:.2f}, Min: {min_cam:.2f})')
...
f_cam, Pcam = welch(camd['Cam3 Position X'], fs=60, nperseg=nperseg, noverlap=noverlap, nfft=Nfft)
