...
# Load Camera data
camera_file_path = 'Exp1_10s_2024-11-19_21-51-23.csv'
cam = pd.read_csv(camera_file_path)

# Load LDV data
ldv_file_path = 'protocol_optoNCDT-ILD1420_2024-11-19_21-52-32.022.csv'
...
cam_resampled = cam_resampled[30:]  # Remove initial samples
