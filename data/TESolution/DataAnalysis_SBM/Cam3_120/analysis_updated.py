...
DELAY = 32  # Delay in seconds to align LDV and Camera data

# Load Camera data
camera_file_path = 'Sweep_1_30Hz_120s_2024-11-19_23-37-24.csv'
cam = pd.read_csv(camera_file_path)

# Load LDV data
ldv_file_path = 'protocol_optoNCDT-ILD1420_2024-11-19_23-37-24.159.csv'
...
fft_levels = 12  # Number of FFT levels
Nfft = 2 ** fft_levels
