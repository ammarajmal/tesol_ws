...
time_ = 15*60
exp = 10
camera_data_path = "data_Exp1_60s_2024-09-14_12-25-15.csv"
ldv_data_path = "protocol_optoNCDT-ILD1420_2024-09-14_12-25-15.895.csv"
val = 7
...
plt.figure(1)
plt.plot(resampled_time[:time_], ldvd[:time_], label=f'LDV (Max: {max_ldv:.2f}, Min: {min_ldv:.2f})')
plt.plot(resampled_time[:time_], camd['Cam1 Position Y'][:time_], label=f'Cam1 (Max: {max_cam1:.2f}, Min: {min_cam1:.2f})')
plt.plot(resampled_time[:time_], camd['Cam2 Position Y'][:time_], label=f'Cam2 (Max: {max_cam2:.2f}, Min: {min_cam2:.2f})')
