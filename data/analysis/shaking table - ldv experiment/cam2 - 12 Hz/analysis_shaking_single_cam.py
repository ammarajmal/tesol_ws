...
freq_ = 10
camera_ = 2
camera_data_path = "data_Exp1_10s_2024-09-14_05-58-26.csv"
ldv_data_path = "protocol_optoNCDT-ILD1420_2024-09-14_05-58-27.341.csv"
val = 36
...
set_seconds_idx = np.where(resampled_time <= 2)[0]
