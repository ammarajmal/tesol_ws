...
exp = 1
camera_data_path = "data_Exp1_10s_2024-09-14_01-55-46.csv"
ldv_data_path = "protocol_optoNCDT-ILD1420_2024-09-14_01-55-47.362.csv"
val = 41
...
ldvf = filtfilt(b, a, ldv_dc_removed.ravel())  # Filter the data after removing the DC component
...
# Find the maximum and minimum values for LDV and Camera data using idxmax() and idxmin()
max_ldv = ldvd.max()
min_ldv = ldvd.min()
...
max_diff_signal = max_ldv - max_cam
min_diff_signal = min_ldv - min_cam
...
plt.text(0.05, 0.95, f'Difference in Max: {max_diff_signal:.2f}, Difference in Min: {min_diff_signal:.2f}', transform=plt.gca().transAxes, color='red')
# plt.text(0.05, 0.90, f'Difference in Min: {min_diff_signal:.2f}', transform=plt.gca().transAxes, color='red')
